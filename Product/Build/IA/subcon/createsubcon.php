  ...
  <!--- BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAK BREAKBREAK BREAK BREAK BREAK BREAK -->
    ...
    <div class="container">
        <form action="subcon.php" method="POST">
            <input type="hidden" id="id" name="uniqueid"><br>
            <label for="label">Name:</label>
            <input type="text" id="name" name="name" required><br>
            <label for="label">what does subcon do:</label>
            <input type="text" id="work" name="work" required><br>
            <label for="label">how much is the agreed pay:</label>
            <input type="number" id="pay" name="pay" required><br>
