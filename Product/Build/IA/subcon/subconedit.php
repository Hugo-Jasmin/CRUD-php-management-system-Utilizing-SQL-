...
if (!$conn) {
    ...
    <div class="container">
        <form action="subconupdate.php" method="POST">    
			      <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
            <label for="label">Newname:</label>
            <input type="text" id="Newname" name="Newname" value="<?php echo $d['name']; ?>" required><br>
            <label for="label">Newwork:</label>
            <input type="text" id="Newwork" name="Newwork" value="<?php echo $d['work']; ?>" required><br>
            <label for="label">newPay:</label>
            <input type="number" id="newPay" name="newPay" value="<?php echo $d['pay']; ?>" required><br>
